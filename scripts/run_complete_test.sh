...
run_commands() {
  ...
  for ((i = 0; i < n; i++)); do
    ...
    python main_multilabel_classification.py --dataset_name PubMed  --batch_norm --do_eval --print_result --model_type DeltaGNN --num_epoch 300 --remove_edges 30 --max_communities 20 --hidden_channels 1024 --topological_measure random
    python main_multilabel_classification.py --dataset_name PubMed  --batch_norm --do_eval --print_result --model_type DeltaGNN --num_epoch 300 --remove_edges 30 --max_communities 20 --hidden_channels 1024 --topological_measure degree_centrality
    python main_multilabel_classification.py --dataset_name PubMed  --batch_norm --do_eval --print_result --model_type DeltaGNN --num_epoch 300 --remove_edges 30 --max_communities 20 --hidden_channels 1024 --topological_measure eigenvector_centrality
