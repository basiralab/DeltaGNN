...
class GCNConvWithAggregation(MessagePassing):
    ...
    def forward(self, x: Tensor, edge_index: Adj,
        ...
        x_aggregated = self.propagate(edge_index, x=x, edge_weight=edge_weight)

        out = self.lin(x_aggregated)

        if self.bias is not None:
            out = out + self.bias

        return out, x_aggregated
