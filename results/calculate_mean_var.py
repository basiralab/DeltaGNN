...
def calculate_mean_and_variance(filename):
    ...
    grouping_columns = ['Dataset', 'Model_Type', 'Node_Num', 'Hidden_Dimension', 'Max_Communities', 'Remove_Edges', 'Epochs','Topological_Measure','Make_Unbalanced','Dense','Flow_Control','Linear']
